...
# cap = cv2.VideoCapture('media/persons/2022/02/10/WIN_20220210_22_07_52_Pro.mp4')
# grabbed, frame = cap.read()
frame_count = 0
# if grabbed:
#     cv2.imwrite('grabbed.jpg', frame)

face_image = face_recognition.load_image_file('grabbed.jpg')
face_encoding = face_recognition.face_encodings(face_image)[0]
cv2.imshow('T', face_image)
cv2.waitKey(10000)
# while grabbed:
#     cv2.imshow('this is image', frame)
#     grabbed, frame = cap.read()
#     frame_count += 1
